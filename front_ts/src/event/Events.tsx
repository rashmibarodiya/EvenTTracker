                                    ...
                                    <div className="flex flex-col sm:flex-row sm:justify-between items-center gap-2">
                                        <button
                                            ...
                                            className={`px-4 py-2 w-full sm:w-auto rounded-md text-white ${
                                                event.done ? "bg-green-600" : "bg-gray-700 hover:bg-gray-600"
...
function Update({ event, onClose, onSave }: UpdateProps) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            onSave(res.data); // Pass updated event back to parent
        } catch (error) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black
         bg-opacity-50 backdrop-blur-sm">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
                ...
                <button onClick={handleSubmit} className="w-full py-2 bg-gray-800 text-white rounded-md mb-2">Submit</button>
